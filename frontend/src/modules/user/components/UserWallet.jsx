...
const UserWallet = () => {
    ...
    return (
        <div className="min-h-screen pb-20 bg-slate-50">
            {/* Header for Mobile */}
            <div className="md:hidden sticky top-0 z-40 px-4 py-4 bg-white shadow-sm">
                <h1 className="text-xl font-bold text-slate-800">{getTranslatedText("My Wallet")}</h1>
            </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-3">
                            {transactions.map((tx, index) => {
                                ...
                                let label = getTranslatedText("Transaction");
